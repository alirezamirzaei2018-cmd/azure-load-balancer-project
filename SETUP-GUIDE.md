...
1. **Can't connect via Bastion**
   - Verify VNet peering is "Connected"
   - Check Bastion deployment completed
...
3. **DNS doesn't resolve**
   - Verify A record points to LB IP
   - Check virtual network links
   - Ensure client VM is in linked VNet

4. **Load balancer doesn't alternate**
